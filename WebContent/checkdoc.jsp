...
<body>
	<div>
		<nav class="navbar navbar-expand-sm bg-light">
			<ul class="navbar-nav">
				<li class="nav-item">
					<a class="nav-link" href="#" onclick="shownotChecked()">待审核公文</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="#" onclick="showChecked()">已审核公文</a>
				</li>
			</ul>
		</nav>
	</div>
		...
		<table class="table table-hover table-striped table-bordered table-sm">
			...
			<c:forEach var="l" items="<%=list %>" varStatus="i">
				<tr>
					...
					<td>${l.getResult() }</td>
					<td><a href="#" onclick="docheck(${i.index+1})">审核</a></td>
				</tr>
			</c:forEach>
		</table>
...
<script>
	...
	{
		window.location="checkDoc?type=checked"
	}
